...
```{r echo=TRUE, results="show",message=FALSE,fig.height=6,fig.width=12, include=F}
...
```{r echo=TRUE, results="show",message=FALSE, fig.height=4,fig.width=8,include=F}
...
```{r echo=TRUE, results="show",message=FALSE,fig.height=6,fig.width=8, include=F}
set.seed(423423)
